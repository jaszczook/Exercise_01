...
public class ItemDbHelper extends SQLiteOpenHelper {
    ...
    public long addItem(String name, int price, int quantity, boolean isBought, SQLiteDatabase db) {
    ...
    public int updateItem(int id, String name, int price, int quantity, boolean isBought, SQLiteDatabase db) {
        ContentValues contentValues = new ContentValues();
        contentValues.put(ItemContract.ItemEntry.NAME, name);
        contentValues.put(ItemContract.ItemEntry.PRICE, price);
        contentValues.put(ItemContract.ItemEntry.QUANTITY, quantity);
    ...
    public int deleteItem(int id, SQLiteDatabase db) {
        String selection = ItemContract.ItemEntry._ID + " = " + id;
